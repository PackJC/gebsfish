...
- **Shrimp is now hook bait** — net-caught vanilla Shrimp attaches to the hook (and traps) like the minnow does, with its own bait-matrix row: the signature reef/tropical bait (2.5x — the one category no other bait favored) and a strong general saltwater choice (1.8x small, 1.5x medium saltwater). Net it, keep it fresh in the Bait Bucket, hook it
