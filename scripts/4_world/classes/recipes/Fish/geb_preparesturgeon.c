class PrepareSturgeon extends PrepareFish {
	int ran;
	override void Init(){
		super.Init();
		//INGREDIENTS-----------------------------------------------------------------------------------------------------------
		//Ingredient 1
		InsertIngredient(0,"geb_Sturgeon");//you can insert multiple ingredients this way
		...
		for (int i = 0; i < ran; ++i){
			AddResult("geb_SturgeonFilletMeat");//add results here
