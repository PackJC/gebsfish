class PrepareShrimp extends PrepareFish
{
	int ran;	
	override void Init()
	{
		...
		auto parts = fillets_chance_map.Get("geb_Shrimp");
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Shrimp");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < ran; ++i){
			AddResult("geb_ShrimpFilletMeat");//add results here
