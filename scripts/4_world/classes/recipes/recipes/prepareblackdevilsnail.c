...
class PrepareBlackdevilsnail extends PrepareFish
{
	override void Init()
	{
		auto geb_Blackdevilsnail_map = FileReader.GetFilletMap();
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Blackdevilsnail");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < geb_Blackdevilsnail_map["geb_Blackdevilsnail"]; ++i){
