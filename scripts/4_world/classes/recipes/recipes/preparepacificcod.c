class PreparePacificcod extends PrepareFish
{
	int ran;	
	override void Init()
	{
		...
		auto parts = fillets_chance_map.Get("geb_Pacificcod");
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Pacificcod");//you can insert multiple ingredients this way
