class PrepareSauger extends PrepareFish
{
	int ran;	
	override void Init()
	{
		...
		auto parts = fillets_chance_map.Get("geb_Sauger");
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Sauger");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < ran; ++i){
			AddResult("geb_SaugerFilletMeat");//add results here
