...
class PrepareBluetang extends PrepareFish
{
	override void Init()
	{
		auto geb_Bluetang_map = FileReader.GetFilletMap();
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Bluetang");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < geb_Bluetang_map["geb_Bluetang"]; ++i){
			AddResult("geb_BluetangFilletMeat");//add results here
