class PrepareKingcrab extends PrepareFish
{
	...
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Kingcrab");//you can insert multiple ingredients this way
		...
		for (int i = 0; i < ran; ++i){
			AddResult("KingcrabFilletMeat");//add results here
			AddResult("KingcrabLegs");//add results here
