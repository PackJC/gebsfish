...
class PrepareBluegill extends PrepareFish
{
	override void Init()
	{
		auto geb_Bluegill_map = FileReader.GetFilletMap();
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Bluegill");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < geb_Bluegill_map["geb_Bluegill"]; ++i){
			AddResult("geb_BluegillFilletMeat");//add results here
