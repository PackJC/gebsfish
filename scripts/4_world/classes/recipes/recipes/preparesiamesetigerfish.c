class PrepareSiamesetigerfish extends PrepareFish
{
	int ran;	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Siamesetigerfish");//you can insert multiple ingredients this way
		...
		for (int i = 0; i < ran; ++i){
			AddResult("SiamesetigerfishFilletMeat");//add results here
