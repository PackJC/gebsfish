class PrepareStarfish extends PrepareFish
{
	int ran;	
	override void Init()
	{
		...
		auto parts = fillets_chance_map.Get("geb_Starfish");
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Starfish");//you can insert multiple ingredients this way
