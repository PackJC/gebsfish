class PrepareWhitebass extends PrepareFish
{
	int ran;	
	override void Init()
	{		
		...
		auto parts = fillets_chance_map.Get("geb_Whitebass");
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Whitebass");//you can insert multiple ingredients this way
