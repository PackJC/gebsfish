class PrepareYellowfintuna extends PrepareFish
{
	int ran;	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Yellowfintuna");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		ran = Math.RandomFloatInclusive(m_gebsConfig.YellowfinTuna.MeatMin,m_gebsConfig.YellowfinTuna.MeatMax);
		for (int i = 0; i < ran; ++i){
			AddResult("geb_YellowfintunaFilletMeat");//add results here
