class PrepareLobster extends PrepareFish
{
	...
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"Lobster");//you can insert multiple ingredients this way
		...
		for (int i = 0; i < ran; ++i){
			AddResult("LobsterFilletMeat");//add results here
			AddResult("LobsterTail");//add results here
