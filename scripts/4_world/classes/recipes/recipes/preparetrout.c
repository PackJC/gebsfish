...
class PrepareBrownTrout extends PrepareFish
{
	override void Init()
	{
		m_Name = "#STR_gutandprepare0";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0, "geb_BrownTrout");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < 2; ++i) {
			AddResult("geb_BrownTroutFilletMeat");//add results here
			m_ResultSetFullQuantity[i] = false;//true = set full quantity, false = do nothing
			m_ResultSetQuantity[i] = -1;//-1 = do nothing
			m_ResultSetHealth[i] = -1;//-1 = do nothing
			m_ResultInheritsHealth[i] = 0;// (value) == -1 means do nothing; a (value) >= 0 means this result will inherit health from ingredient number (value);(value) == -2 means this result will inherit health from all ingredients averaged(result_health = combined_health_of_ingredients / number_of_ingredients)
...
class PrepareBrookTrout extends PrepareFish
{
	override void Init()
	{
		m_Name = "#STR_gutandprepare0";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0, "geb_BrookTrout");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < 2; ++i) {
			AddResult("geb_BrookTroutFilletMeat");//add results here
			m_ResultSetFullQuantity[i] = false;//true = set full quantity, false = do nothing
			m_ResultSetQuantity[i] = -1;//-1 = do nothing
			m_ResultSetHealth[i] = -1;//-1 = do nothing
			m_ResultInheritsHealth[i] = 0;// (value) == -1 means do nothing; a (value) >= 0 means this result will inherit health from ingredient number (value);(value) == -2 means this result will inherit health from all ingredients averaged(result_health = combined_health_of_ingredients / number_of_ingredients)
...
class PrepareCutthroatTrout extends PrepareFish
{
	override void Init()
	{
		m_Name = "#STR_gutandprepare0";
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0, "geb_CutthroatTrout");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < 2; ++i) {
			AddResult("geb_CutthroatTroutFilletMeat");//add results here
			m_ResultSetFullQuantity[i] = false;//true = set full quantity, false = do nothing
			m_ResultSetQuantity[i] = -1;//-1 = do nothing
			m_ResultSetHealth[i] = -1;//-1 = do nothing
			m_ResultInheritsHealth[i] = 0;// (value) == -1 means do nothing; a (value) >= 0 means this result will inherit health from ingredient number (value);(value) == -2 means this result will inherit health from all ingredients averaged(result_health = combined_health_of_ingredients / number_of_ingredients)
...
class PrepareLakeTrout extends PrepareFish
{
	override void Init()
	{
		m_Name = "#STR_gutandprepare0";
		...
		//----------------------------------------------------------------------------------------------------------------------
		for (int i = 0; i < 2; ++i) {
			AddResult("geb_LakeTroutFilletMeat");//add results here
			m_ResultSetFullQuantity[i] = false;//true = set full quantity, false = do nothing
			m_ResultSetQuantity[i] = -1;//-1 = do nothing
			m_ResultSetHealth[i] = -1;//-1 = do nothing
			m_ResultInheritsHealth[i] = 0;// (value) == -1 means do nothing; a (value) >= 0 means this result will inherit health from ingredient number (value);(value) == -2 means this result will inherit health from all ingredients averaged(result_health = combined_health_of_ingredients / number_of_ingredients)
