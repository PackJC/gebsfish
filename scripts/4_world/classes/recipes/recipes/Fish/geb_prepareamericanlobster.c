class PrepareAmericanLobster extends PrepareFish {
	int ran;	
	override void Init(){
		super.Init();
		//INGREDIENTS-----------------------------------------------------------------------------------------------------------
		//Ingredient 1
		InsertIngredient(0,"geb_AmericanLobster");//you can insert multiple ingredients this way
		...
		//RESULTS----------------------------------------------------------------------------------------------------------------
		//Result 1
		AddResult("geb_AmericanLobsterTail");//add results here
		...
		//Result 2
		ran = Math.RandomFloatInclusive(m_gebsConfig.AmericanLobster.MeatMin,m_gebsConfig.AmericanLobster.MeatMax);
		for (int i = 1; i < ran; ++i){
