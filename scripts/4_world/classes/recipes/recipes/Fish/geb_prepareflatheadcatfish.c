class PrepareFlatHeadCatFish extends PrepareFish {
	int ran;	
	override void Init(){
		super.Init();
		//INGREDIENTS-----------------------------------------------------------------------------------------------------------
		...
		//RESULTS----------------------------------------------------------------------------------------------------------------
		//Result 1
		ran = Math.RandomFloatInclusive(m_gebsConfig.FlatHeadCatFish.MeatMin,m_gebsConfig.FlatHeadCatFish.MeatMax);
		for (int i = 0; i < ran; ++i){
