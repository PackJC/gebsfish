class PrepareCherrysalmon extends PrepareFish
{
	...
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Cherrysalmon");//you can insert multiple ingredients this way
		...
		//----------------------------------------------------------------------------------------------------------------------
		ran = Math.RandomFloatInclusive(m_gebsConfig.CherrySalmon.MeatMin,m_gebsConfig.CherrySalmon.MeatMax);
		for (int i = 0; i < ran; ++i){
