	...
	void CreateConfig(string CONFIG_PATH)
	{
			...
			switch (CONFIG_PATH) {
				case "$profile:gebsfish/Saltwater.cfg":
					...
					FPrintln(f, "geb_ANGELFISH_CHANCE=25");
					FPrintln(f, "geb_BLUEMARLIN_CHANCE=25");
					FPrintln(f, "geb_BONITA_CHANCE=25");
					FPrintln(f, "geb_CHERRYSALMON_CHANCE=25");
					FPrintln(f, "geb_FLATHEADMULLET_CHANCE=25");
					FPrintln(f, "geb_LEOPARDSHARK_CHANCE=25");
					FPrintln(f, "geb_PACIFICCOD_CHANCE=25");
					FPrintln(f, "geb_REDHEADCICHLID_CHANCE=25");
					FPrintln(f, "geb_ROUGHNECKROCK_CHANCE=25");
					FPrintln(f, "geb_SEVERUM_CHANCE=25");
					FPrintln(f, "geb_SHRIMP_CHANCE=25");
					FPrintln(f, "geb_BLUETANG_CHANCE=25");
					FPrintln(f, "geb_HAIRTAILFISH_CHANCE=25");
					FPrintln(f, "geb_HUMPHEADWRASSE_CHANCE=25");
					FPrintln(f, "geb_SIAMESETIGERFISH_CHANCE=25");
					FPrintln(f, "geb_ASIANSEABASS_CHANCE=25");
					FPrintln(f, "geb_JELLYFISH_CHANCE=25");
				...
				case "$profile:gebsfish/Freshwater.cfg":
					...
					FPrintln(f, "geb_BLUEGILL_CHANCE=25");
					FPrintln(f, "geb_BLACKBASS_CHANCE=25");
					FPrintln(f, "geb_CATFISH_CHANCE=25");
					FPrintln(f, "geb_LARGEMOUTHBASS_CHANCE=25");
					FPrintln(f, "geb_MINNOW_CHANCE=25");
					FPrintln(f, "geb_NORTHERNPIKE_CHANCE=25");
					FPrintln(f, "geb_PERCH_CHANCE=25");
